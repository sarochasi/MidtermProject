<!-- ***** CURRENTLY TESTING ***** -->
<!-- If you would like to test, go into UserController > login.do  -->
<!-- Then temporarily change | return "account"; (to) return "accountidea"   -->
...
<!-- Bootstrap/CSS scrolling cards (style)(for user's workouts, and their favorite workouts) -->
<style>
.scrolling-wrapper {
	overflow-x: auto;
	white-space: nowrap;
